...
const overlay = new DeckOverlay({
    layers: [
        new GeoCircle({
            data: [
               {center: [7.099481920327829, 21.07932313150917], radius: 9944545.500957435, color: [0,0,0,25]}, 
               {center: [7.099481920327829, 21.07932313150917], radius: 9340385.566755507, color: [0,0,0, 25]},
               {center: [7.099481920327829, 21.07932313150917], radius: 8673215.169130113, color: [0,0,0, 25]},
               {center: [7.099481920327829, 21.07932313150917], radius: 8006044.77150472, color: [0,0,0, 25]},
            ],
